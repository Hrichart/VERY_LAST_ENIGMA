...
public class Crypt_decrypt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ltt1 = findViewById(R.id.ltt_I);
        ltt2 = findViewById(R.id.ltt_II);
        ltt3 = findViewById(R.id.ltt_III);
        ltt4 = findViewById(R.id.ltt_IV);
        ...
        ltt3.setText(String.valueOf(letters[offset3]));
        ltt4.setText(String.valueOf(letters[offset4]));
    }
    ...
    public void reset(View view){
        TextView ltt1 = findViewById(R.id.ltt_I);
        TextView ltt2 = findViewById(R.id.ltt_II);
        TextView ltt3 = findViewById(R.id.ltt_III);
        TextView ltt4 = findViewById(R.id.ltt_IV);
